...
package org.gradlefx.ide.validators.actions
...
class ValidateIDEProjectTaskAction implements Action<AbstractIDEProject> {

    @Override
    void execute(AbstractIDEProject task) {
