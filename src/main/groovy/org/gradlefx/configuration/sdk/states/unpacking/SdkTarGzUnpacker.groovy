...
class SdkTarGzUnpacker extends AbstractSdkUnpacker {

    SdkTarGzUnpacker(Project project, SdkInstallLocation sdkInstallLocation, File packagedSdkFile, String someSdkRootDirectoryName) {
