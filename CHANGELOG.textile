...
h5. Compatibility
* fixed: under gradle 3.1, gradlefx throws 'ResolveContext' exception https://github.com/GradleFx/GradleFx/pull/247

h5. New Features
* Added 'airMobile.hideAneLibSymbols' property for use with multiple ANEs in your iOS project https://github.com/GradleFx/GradleFx/pull/246

h3. v1.4.0

h5. Compatibility
* renamed "test" and "build" tasks to "testFx" and "buildFx" since the old names aren't allowed anymore in Gradle 3 https://github.com/GradleFx/GradleFx/pull/236
